#ifndef WARPCONSTANTS_H
#define WARPCONSTANTS_H
...
namespace amnezia
{
    namespace protocols
    {
        namespace warp
        {
            ...
            constexpr char defaultJunkPacketMinSize[] = "23";
            constexpr char defaultJunkPacketMaxSize[] = "911";
            constexpr char defaultInitPacketJunkSize[] = "0";
            constexpr char defaultResponsePacketJunkSize[] = "0";
            ...
            // WARP endpoint
            constexpr char endpointHost[] = "162.159.192.1";
            ...
            // Special junk packet I1 (QUIC Initial-like blob)
