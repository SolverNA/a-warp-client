...
#define TUNNEL_NAMED_PIPE \
  "\\\\."                 \
  "\\pipe\\ProtectedPrefix\\Administrators\\AmneziaWG\\AWARP"
...
bool WindowsTunnelService::start(const QString& configData) {
  ...
  service = CreateService(scm, TUNNEL_SERVICE_NAME, L"AWARP (tunnel)",
  ...
  SERVICE_DESCRIPTION sd = {
      (wchar_t*)L"Manages the AWARP tunnel connection"};
