set(CPACK_PACKAGE_VENDOR            AWARP)
set(CPACK_PACKAGE_VERSION           ${AMNEZIAVPN_VERSION})
if(WIN32)
    set(CPACK_PACKAGE_FILE_NAME "AWARP_${AMNEZIAVPN_VERSION}_windows_x64")
elseif(APPLE AND NOT IOS AND NOT MACOS_NE)
    set(CPACK_PACKAGE_FILE_NAME "AWARP_${AMNEZIAVPN_VERSION}_macos_x64")
elseif(LINUX AND NOT ANDROID)
    set(CPACK_PACKAGE_FILE_NAME "AWARP_${AMNEZIAVPN_VERSION}_linux_x64")
endif()
set(CPACK_PACKAGE_INSTALL_DIRECTORY AWARP)
set(CPACK_PACKAGE_EXECUTABLES       AWARP AWARP)
...
list(PREPEND CPACK_COMPONENTS_ALL AWARP)
...
set(CPACK_IFW_PACKAGE_NAME                          AWARP)
set(CPACK_IFW_PACKAGE_TITLE                         AWARP)
...
set(CPACK_PRODUCTBUILD_IDENTIFIER       app.awarp)
set(CPACK_PREFLIGHT_AWARP_SCRIPT        ${CMAKE_SOURCE_DIR}/deploy/data/macos/post_uninstall.sh)
set(CPACK_POSTFLIGHT_AWARP_SCRIPT       ${CMAKE_SOURCE_DIR}/deploy/data/macos/post_install.sh)
...
if(LINUX AND NOT ANDROID)
    install(FILES
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/AWARP.service
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/AWARP.png
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/AWARP.desktop
...
if (APPLE AND NOT IOS AND NOT MACOS_NE)
    install(FILES ${CMAKE_SOURCE_DIR}/deploy/data/macos/AWARP.plist
        DESTINATION "AWARP.app/Contents/Resources"
        COMPONENT AWARP
    )
endif()

include(CPackIFW)
cpack_ifw_configure_component(AWARP
