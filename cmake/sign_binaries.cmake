...
if(APPLE)
    ...
    list(FILTER client_exec INCLUDE REGEX [[AWARP$]])
    set(service_exec ${execs})
    list(FILTER service_exec INCLUDE REGEX [[AWARP-service$]])
    set(other_execs ${execs})
    list(FILTER other_execs EXCLUDE REGEX [[AWARP$|AWARP-service$]])
